...
const RenderTwoAvatars = ({a3ref, vsRef, a4ref}) => (
...
const RenderThreeAvatars = ({aref, a3ref, a4ref, vsRef}) => (
  <>
...
const RenderFourAvatars = ({aref, a3ref, a4ref, vsRef, a5ref}) => (
  <>
    <View style={styles.upperBlock}>
      <Animated.View ref={aref}>
        <Image
...
const RenderFiveAvatars = ({aref, a3ref, a4ref, vsRef, a5ref, a2ref}) => (
  <>
    <View style={styles.upperBlock}>
      <Animated.View ref={aref}>
        <Image
      ...
      <View
        ...
        <View
          ...
          <View
            ...
            {NO_OF_AVATARS === 2 && (
              <RenderTwoAvatars a3ref={a3ref} a4ref={a4ref} vsRef={vsRef} />
            )}
            {NO_OF_AVATARS === 3 && (
              <RenderThreeAvatars
                aref={aref}
